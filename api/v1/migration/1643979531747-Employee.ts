...
export class Employee1643979531747 implements MigrationInterface {
    name = 'Employee1643979531747'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`material\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(100) NOT NULL, \`type\` varchar(100) NOT NULL, \`serial_number\` varchar(100) NOT NULL, \`file\` varchar(100) NOT NULL, \`purpose\` varchar(100) NOT NULL, \`in_date\` varchar(100) NOT NULL, \`out_date\` varchar(100) NOT NULL, \`is_recommend\` tinyint NOT NULL DEFAULT 0, \`is_approved\` tinyint NOT NULL DEFAULT 0, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`remarks\` varchar(100) NOT NULL, \`update_date\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`delete_date\` datetime(6) NULL, \`zoneId\` int NULL, \`carryById\` int NULL, \`recommendById\` int NULL, \`approvedById\` int NULL, \`deletedById\` int NULL, \`addedById\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`material_area_permitted_area\` (\`materialId\` int NOT NULL, \`areaId\` int NOT NULL, INDEX \`IDX_15e6cbbebced5281c9c3070dd6\` (\`materialId\`), INDEX \`IDX_af0742e22bd3f548f97519fe42\` (\`areaId\`), PRIMARY KEY (\`materialId\`, \`areaId\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_af0742e22bd3f548f97519fe42\` ON \`material_area_permitted_area\``);
        await queryRunner.query(`DROP INDEX \`IDX_15e6cbbebced5281c9c3070dd6\` ON \`material_area_permitted_area\``);
        await queryRunner.query(`DROP TABLE \`material_area_permitted_area\``);
